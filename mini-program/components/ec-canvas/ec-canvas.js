...
Component({
  ...
  ready: function () {
    console.log('ECharts 组件 ready，ec 数据:', this.data.ec);
  ...
  observers: {
    'ec': function(newVal) {
      console.log('ECharts 组件 ec 数据变化:', newVal);
  ...
  methods: {
    ...
    initByOldWay(callback) {
      ...
      query.select('.ec-canvas').boundingClientRect(res => {
        ...
        // 添加对直接传递 option 的支持
        else if (this.data.ec && this.data.ec.option) {
    ...
    initByNewWay(callback) {
      ...
      query
        ...
        .exec(res => {
          ...
          const canvasDpr = deviceInfo.pixelRatio || 1;
